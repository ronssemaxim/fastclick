#ifndef CLICK_TOOVSDPDKRING_USERLEVEL_HH
#define CLICK_TOOVSDPDKRING_USERLEVEL_HH
...
ToOVSDPDKRing(MEMPOOL m, RING_NAME dpdkr, [, I<keywords> BURST, etc.])
...
=e
  ...
  ... -> ToOVSDPDKRing(MEM_POOL 2, FROM_PROC nf1_tx, TO_PROC nf2_rx, IQUEUE 1024, BURST 32)
...
class ToOVSDPDKRing : public BatchElement {

    public:
        ToOVSDPDKRing () CLICK_COLD;
        ~ToOVSDPDKRing() CLICK_COLD;

        const char    *class_name() const { return "ToOVSDPDKRing"; }
...
#endif // CLICK_TOOVSDPDKRING_USERLEVEL_HH
